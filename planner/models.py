...
class Shift(models.Model):
    ...
    def __str__(self) -> str:
        return f"{self.user_id} {self.shift_type} {self.date} {self.start_time}-{self.end_time}"
...
class Commitment(models.Model):
    ...
    def __str__(self) -> str:
        return f"{self.user_id} {self.title} ({self.priority})"
